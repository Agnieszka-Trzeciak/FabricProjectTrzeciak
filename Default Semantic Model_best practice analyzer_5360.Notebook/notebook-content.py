...
dataset = "Default Semantic Model" # Enter the name or ID of the semantic model
workspace = "itransition Data Engineering Final Project" # Enter the workspace name or ID in which the semantic model exists
